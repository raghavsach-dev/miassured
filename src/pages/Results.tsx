...
import {
  Box, Heading, Text, VStack, Divider, Table, Thead, Tbody, Tr, Th, Td, Card, CardBody, Badge, List, ListItem, ListIcon, Accordion, AccordionItem, AccordionButton, AccordionPanel, AccordionIcon, Alert, AlertIcon
...
const BenefitsBarChart = ({ data }: BenefitsBarChartProps) => {
  ...
  if (numericData.length === 0) {
    return <Text color="gray.400" textAlign="center">No numeric sublimit data to display as a chart.</Text>;
  }
...
const Results = () => {
  ...
  return (
    <Box p={8}>
      <Heading mb={6}>Policy Analysis Results</Heading>
